...
import org.chzz.market.domain.imagev2.service.ImageV2Service;
...
class AuctionV2ControllerTest extends AuthenticatedRequestTest {
    @MockBean
    ...
    void testPreAuctionRegistration() throws Exception {
        ...
        verify(imageV2Service).uploadImages(any());
    }
